...
#SBATCH --job-name=relaxed_hybrid_lex_ilp
...
# SRG ILP Benchmark: relaxed formulation with hybrid lex-leader symmetry breaking.
#
# Minimises the number of λ/μ violations while enforcing k-regularity.
# Objective = 0 certifies a valid SRG.
#
# Usage:
#   sbatch scripts/srg_bench_relaxed_hybrid_lex.sh
#
# After all tasks finish:
#   python scripts/aggregate_bench.py bench_output/relaxed_hybrid_lex_ilp
