...
# SRG ILP Benchmark: exact formulation with fix-neighbors + lex-leader
# (combined symmetry breaking — most constrained configuration).
#
# Usage:
#   sbatch scripts/srg_bench_fix_lex_array.sh
#
# To target specific open-case indices only:
#   sbatch --array=5,12,17 scripts/srg_bench_fix_lex_array.sh
...
# ── Logging ───────────────────────────────────────────────────────────────
echo "=== SRG ILP Benchmark (fix-neighbors + lex-leader) ==="
